...
- **Gate verdict** -- present when a G4 (post-`ivy_verify`) gate has fired this turn; see `tool-renderers/ivy_verdict.md` for the block format. Place after "Failure Details" and before "Next Steps".
