...
| `[G2 modeling gate]` | PostToolUse | `posttooluse/gates/g2-modeling.py` | Ivy layer file written during `scaffold` workflow; G2 adversarial modeling critic dispatched. |
| `[G3 test-spec gate]` | PostToolUse | `posttooluse/gates/g3-testspec.py` | Ivy test-spec file written during `scaffold` workflow; G3 adversarial test-spec critic dispatched. |
| `[G4 verification gate]` | PostToolUse | `record/workflow-error.py` | `ivy_verify` completed; G4 verification critic dispatched. |
| `[G5 trace-analysis gate]` | PostToolUse | `posttooluse/gates/g5-trace.py` | `ivy_iut_test` completed; G5 trace-analysis critic dispatched. |
