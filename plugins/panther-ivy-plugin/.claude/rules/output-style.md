...
| `[G2 modeling gate]` | PostToolUse | `assess-modeling.py` | Ivy layer file written during `scaffold` workflow; G2 adversarial modeling critic dispatched. |
| `[G3 test-spec gate]` | PostToolUse | `assess-testspec.py` | Ivy test-spec file written during `scaffold` workflow; G3 adversarial test-spec critic dispatched. |
