...
The Ivy LSP exposes navigational and diagnostic operations through Claude Code's native LSP tool. This file documents the operations and the canonical multi-tool coordination workflows. The host skill (`knowledge-ivy-toolkit`) points here when LSP work is in scope.
