...
description: "Use when working with NCT (compositional testing), NACT (attack testing), or NSCT (simulation testing) methodology. Covers the complete 10-step NCT workflow, APT 6-stage lifecycle for NACT, and Shadow NS configuration for NSCT."
---

# PANTHER Formal Testing Methodologies

This skill provides deep reference material for all three PANTHER formal testing methodologies: NCT, NACT, and NSCT. All three share the same Ivy formal specification language, 14-layer template, and before/after monitor pattern. They differ in execution environment and testing focus.
