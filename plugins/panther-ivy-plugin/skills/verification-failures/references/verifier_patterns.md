...
Owned by the `verification-failures` skill (Error-pattern catalog section). The orchestrator and critics access this catalog via that skill — either by loading it through the Skill tool or by having the orchestrator read it and embed relevant slices into spawned-critic prompts.
...
- **Source:** Plugin convention; ivy-syntax skill (load via `Skill(skill="panther-ivy-plugin:ivy-syntax")`), syntax-examples reference.
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `ivy-syntax` + coverage-gap memory.
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** Plugin convention; `methodology`.
- **Methodology tag:** `Plugin-Memory`
...
- **Trigger:** A proposed fix for a verification failure is presented without the 6 mandatory research steps from the Debugging methodology section of `verification-failures` (diagnostics by source layer, skill consultation, linter run, working-example search, theory formulation, minimal-fix selection).
...
- **Source:** `skills/verification-failures/SKILL.md` §Debugging methodology, steps 1-6.
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `skills/verification-failures/SKILL.md` §Debugging methodology.
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `skills/verification-failures/SKILL.md` §Counterexample interpretation, Pattern 1 (Missing guard).
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `skills/verification-failures/SKILL.md` §Counterexample interpretation, Pattern 2 (Uninitialized state).
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `skills/verification-failures/SKILL.md` §Counterexample interpretation, Pattern 3 (Incorrect monitor scope).
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `skills/verification-failures/SKILL.md` §Counterexample interpretation, Pattern 4 (Invariant too strong).
- **Methodology tag:** `Plugin-Memory`
...
- **Source:** `skills/verification-failures/SKILL.md` §Counterexample interpretation.
- **Methodology tag:** `Plugin-Memory`
