...
## 6-stage attack-lifecycle scaffolding
...
**Rule.** When adding a new attack-stage file, follow the existing pattern: include `#lang ivy1.7`, include any required apt-layer files at the top, define action stubs with one-line docstrings, and leave protocol-specific implementation to the per-protocol bindings.
