# Tooling Reference — MCP Tool Parameter Documentation

This file contains the full parameter documentation for all ivy-tools MCP tools. The SKILL.md file provides the architecture overview, quick reference, and coordination workflows; this README provides detailed per-tool parameter specs.
