---
name: triage
description: "Diagnose and repair MCP/LSP/Serena stack health. Use when tools time out, 'ivy_status timeout', 'MCP won't connect', stale PIDs, LSP crash, or as preflight before another workflow."
---
