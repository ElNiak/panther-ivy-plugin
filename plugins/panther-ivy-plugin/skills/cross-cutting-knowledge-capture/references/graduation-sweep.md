...
| IUT output analysis (pcap cross-validation, 9-step analysis) | `skills/workflow-verify/references/iut-output-analysis.md` or `skills/knowledge-verification-failures/references/debugging-environment.md` |
