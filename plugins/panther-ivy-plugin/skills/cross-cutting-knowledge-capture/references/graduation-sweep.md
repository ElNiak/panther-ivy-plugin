...
|:--|:--|
| Ivy language patterns (QUIC / BGP generators, serializers, solver mechanics) | `skills/ivy-syntax/references/ivy-1.7-patterns-reference.md` (or `.claude/rules/ivy-patterns.md` if the content is primitive syntax) |
...
| IUT output analysis (pcap cross-validation, 9-step analysis) | `skills/workflow-verify/references/iut-output-analysis.md` or `skills/verification-failures/references/debugging-environment.md` |
