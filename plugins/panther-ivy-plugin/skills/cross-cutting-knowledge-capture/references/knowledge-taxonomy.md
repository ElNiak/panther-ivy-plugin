...
**Persistence targets:**
- Generic (protocol-agnostic, recurring): `skills/verification-failures/references/debugging-environment.md` — append under "Common failures" or create a new subsection
...
**Persistence targets:** `skills/ivy-toolkit/references/tool-catalog.md` (tool-specific, including the journal event types subsection added 2026-04-22) or `skills/verification-failures/references/debugging-environment.md` (triage-specific).
